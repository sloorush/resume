...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Vellore Institute of Technology, Vellore}{Jul 2019 -- Jul 2023}
      {B.Tech in Computer Science and Engineering}{8.37, CGPA}
...
\section{Experience}
 ...
 \resumeSubheadingg
      {\href{https://dyalog.com/}{Dyalog Ltd.}}{Jan 2023 -- Present}
      \resumeItemListStart
        \resumeItem{Programming Language Developer and Tester working on Dyalog APL. (C, APL, Compiler Design, Testing)}
        \resumeItem{Working on the interpreter and introduced a new test suite to test the language features.}
    \resumeItemListEnd
 \resumeSubheadingg
...
\section{Skills and Interests}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Programming Languages}{: APL, Bash, C, Cpp, Go, Haskell, JavaScript, Python, TypeScript} \\
     ...
     \textbf{Interests}{: Coffee, Formula 1, Mechanical Keyboards} \\
    }}
 \end{itemize}
 \vspace{-16pt}
...
\section{Publications}
  \resumeSubHeadingListStart
    \resumeSubheadingg
      {\href{https://ieeexplore.ieee.org/document/10000344}{A Unique Approach to Malware Detection Using Deep Convolutional Neural Networks}}{Nov 2022}
      \resumeItemListStart
